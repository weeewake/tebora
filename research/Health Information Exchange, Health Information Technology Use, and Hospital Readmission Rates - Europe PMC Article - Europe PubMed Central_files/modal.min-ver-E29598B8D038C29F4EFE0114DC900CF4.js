...
}try{if(Wicket.Browser.isIELessThan9()){this.content.contentWindow.location.replace(this.settings.ie8_src)
}else{this.content.contentWindow.location.replace(this.settings.src)
...
for(var b=0;
b<e.length;
b++){if(f.isIframe()===true||this.isParent(e[b],f.content)===false){var d=e[b];
